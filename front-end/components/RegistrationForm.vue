          ...
          >
            <div class="relative">
              <base-input
                ...
                :schema="RegistrationSchema.object.name"
                label="Name"
                icon="heroicons:user"
                required
              />
            ...
            <div>
              <div class="relative">
                <base-input
                  ...
                  :schema="RegistrationSchema.object.email"
                  label="Email"
                  autocomplete="on"
            ...
            <div>
              <div class="relative">
                <base-input
                  ...
                  :schema="RegistrationSchema.object.password"
                  label="Password"
                  placeholder="********"
            ...
            <div>
              <div class="relative">
                <base-input
                  ...
                  :schema="RegistrationSchema.object.passwordConfirm"
            ...
            <div class="relative">
              <base-checkbox
                id="termsOfUse"
                v-model="formState.termsOfUse"
                :schema="RegistrationSchema.object.termsOfUse"
...
type RegistrationInput = Input<typeof RegistrationSchema>;

const formState = ref<RegistrationInput>({
  name: "",
  email: "",
  password: "",
  passwordConfirm: "",

    ...
    <nav aria-label="Main Nav" class="mt-4 flex flex-col space-y-1">
      ...
      <nuxt-link
        ...
        :class="{
          ...
          'bg-white text-gray-500': currentPath !== '/students',
        }"
      >
        <Icon
          class="h-5 w-5 opacity-75"
          :class="
            currentPath === '/students' ? 'text-blue-500' : 'text-gray-500'
          "
      ...
      >
        <Icon
          class="h-5 w-5 opacity-75"
          :class="
            currentPath === '/librarians' ? 'text-blue-500' : 'text-gray-500'
          "
      ...
      >
        <Icon
          class="h-5 w-5 opacity-75"
          :class="currentPath === '/books' ? 'text-blue-500' : 'text-gray-500'"
      ...
      <nuxt-link
        ...
        class="flex items-center gap-2 rounded-lg px-4 py-2 hover:bg-gray-100 hover:text-gray-700"
        :class="{
          'bg-gray-100 text-gray-700': currentPath === '/authors',
          'text-gray-500 hover:bg-gray-100': currentPath !== '/authors',
        }"
      >
        <Icon
          class="h-5 w-5 opacity-75"
          :class="
            currentPath === '/authors' ? 'text-blue-500' : 'text-gray-500'
          "
          name="heroicons:book-open"
        />
        <span
